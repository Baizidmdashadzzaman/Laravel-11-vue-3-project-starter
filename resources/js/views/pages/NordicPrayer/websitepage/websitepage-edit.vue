...
let pagename = ref('Website page');
let url_data = ref('websitepage');
      ...
      <form @submit.prevent="updateData(route.params.id,singledatapage)" class="card-body" enctype="multipart/form-data">
         ...
         <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <img :src="$backendurl+'/resources/language/'+singledatapage.image_show" style="width:150px;border-radius: 5px;">
            </div>
