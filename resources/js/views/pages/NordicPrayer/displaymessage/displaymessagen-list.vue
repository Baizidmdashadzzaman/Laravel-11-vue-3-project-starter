...
const { alldata,getResults,searchResults,validationErrors,urlcall,pageid,loadingBtn,getSingleDataCutomUrl,singledata,updateData,loading,getResultAll } = useDataCall();
                     ...
                     <table class="table table-hover ">
                        ...
                        <tbody class="table-border-bottom-0">
                           <tr v-for="singledata in alldata.data" :key="singledata.id">
                              ...
                              <td><b>{{ singledata.title }}</b></td>
                              <td><b>{{ singledata.message_type }}</b></td>
