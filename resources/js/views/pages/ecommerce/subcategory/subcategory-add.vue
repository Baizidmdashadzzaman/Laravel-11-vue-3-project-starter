      ...
      <form @submit.prevent="saveData()" class="card-body" enctype="multipart/form-data">
         ...
         <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <!-- <img :src="$backendurl+'/resources/country/'+singledatapage.image_show" style="width:150px;border-radius: 5px;"> -->
            </div>
            <div class="col-md-6">
