...
const { allcategory,get_allcategory } = useReuseableData();
const { state_subcategory, } = usemodelData();

const { validationErrors,urlcall,loadingBtn,getSingleData,singledata,updateData,loading } = useDataCall();

const emit = defineEmits(['changeActive'])
const route = useRoute();
let pagename = ref('Subcategory');
let url_data = ref('subcategory');


const singledatapage = reactive({ ...state_subcategory });
         ...
         <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <div class="input-group input-group-merge">
                <select v-model="singledatapage.category_id" class="form-select">
            ...
            <div class="col-md-6">
              ...
              <img :src="$backendurl+'/resources/subcategory/'+singledatapage.image_show" style="width:150px;border-radius: 5px;">
            </div>
            <div class="col-md-6">
              ...
              <img :src="$backendurl+'/resources/subcategory/'+singledatapage.banner_show" style="width:150px;border-radius: 5px;">
            </div>
