                     ...
                     <table class="table table-hover ">
                        ...
                        <tbody class="table-border-bottom-0">
                           <tr v-for="singledata in alldata.data" :key="singledata.id">
                              ...
                              <td><b>{{ singledata.phone }}</b></td>
                              <td><span class="badge bg-label-success me-1" >{{ singledata.status }}</span></td>
                              <td>
                                 <div class="btn-group" role="group" aria-label="Basic example">
                                    <RouterLink :to="{ name: 'admin.productwishlist.list', params: { id: singledata.id } }" class="btn btn-outline-success btn-sm waves-effect waves-light">
                                       <i class="ti ti-heart me-md-2"></i>
                                    </RouterLink>
