...
const { state_origincountry, } = usemodelData();

const { validationErrors,urlcall,loadingBtn,getSingleData,singledata,updateData,loading } = useDataCall();

const emit = defineEmits(['changeActive'])
const route = useRoute();
let pagename = ref('Origin country');
let url_data = ref('origincountry');


const singledatapage = reactive({ ...state_origincountry });
      ...
      <form @submit.prevent="updateData(route.params.id,singledatapage)" class="card-body" enctype="multipart/form-data">
         <div class="alert alert-success alert-dismissible" role="alert" v-if="Object.keys(validationErrors).length > 0">
            ...
            <div class="col-md-6">
              ...
              <img :src="$backendurl+'/resources/origincountry/'+singledatapage.image_show" style="width:150px;border-radius: 5px;">
            </div>
            <div class="col-md-6">
              ...
              <img :src="$backendurl+'/resources/origincountry/'+singledatapage.banner_show" style="width:150px;border-radius: 5px;">
            </div>
