...
watch(singledata, async (newdata, olddata) => {
   ...
   singledatapage.image_sec_show = newdata.image_sec;
      ...
      <form @submit.prevent="updateData(route.params.id,singledatapage)" class="card-body" enctype="multipart/form-data">
         ...
         <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <textarea type="text" v-model="singledatapage.shortdescription" class="form-control" placeholder="enter here"></textarea>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <img :src="$backendurl+'/resources/product/'+singledatapage.image_show" style="width:150px;border-radius: 5px;">
            </div>
            <div class="col-md-6">
              ...
              <img :src="$backendurl+'/resources/product/'+singledatapage.image_sec_show" style="width:150px;border-radius: 5px;">
            </div>
