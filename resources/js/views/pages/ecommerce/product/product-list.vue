                     ...
                     <table class="table table-hover ">
                        ...
                        <tbody class="table-border-bottom-0">
                           <tr v-for="singledata in alldata.data" :key="singledata.id">
                              ...
                              <td>
                                 <div class="btn-group" role="group" aria-label="Basic example">
                                    <RouterLink :to="{ name: 'admin.productstock.list', params: { id: singledata.id } }" class="btn btn-outline-success btn-sm waves-effect waves-light">
                                       Stock
                                    </RouterLink>
                                    <RouterLink :to="{ name: 'admin.productreview.list', params: { id: singledata.id } }" class="btn btn-outline-success btn-sm waves-effect waves-light">
                                       Review
                                    </RouterLink>
                                 </div>
                              </td>
                              ...
                              <td><b>{{ singledata.category?.name }}</b></td>
                              <td><b>{{ singledata.subcategory?.name }}</b></td>
                              <td><b>{{ singledata.subsubcategory?.name }}</b></td>
                              <td><b>{{ singledata.brand?.name }}</b></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
