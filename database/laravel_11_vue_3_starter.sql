...
--
-- Database: `laravel_11_vue_3_starter`
--

-- --------------------------------------------------------

--
-- Table structure for table `aztokens`
--

CREATE TABLE `aztokens` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `aztoken` longtext DEFAULT NULL,
  `aztoken_key` varchar(255) DEFAULT NULL,
  `token_request` bigint(20) NOT NULL DEFAULT 0,
  `aztoken_information` longtext DEFAULT NULL,
...
--
-- Dumping data for table `aztokens`
--

INSERT INTO `aztokens` (`id`, `aztoken`, `aztoken_key`, `token_request`, `aztoken_information`, `status`, `created_at`, `updated_at`) VALUES
(1, 'asd', 'asd', 12, 'asd', 'active', '2024-05-11 02:20:22', '2024-05-11 02:20:22'),
(2, 'ert', 'ert', 12, 'ert', 'active', '2024-05-11 02:22:23', '2024-05-11 02:22:23');
...
(4, '2024_05_03_131033_create_personal_access_tokens_table', 1),
...
(2, 'sdf', 'active', '2024-05-12 07:12:50', '2024-05-12 07:12:50');
...
(1, 'sdsd', 'active', '2024-05-12 06:48:47', '2024-05-12 06:48:47');
...
CREATE TABLE `settings` (
  ...
  `logo_backend` varchar(255) DEFAULT NULL,
...
INSERT INTO `settings` (`id`, `site_name`, `logo`, `logo_backend`, `favicon`, `email`, `phone`, `address`, `description`, `faq`, `aboutus`, `status`, `seo_keyword`, `seo_description`, `created_at`, `updated_at`) VALUES
(1, 'laravel11vue3', '1715409265v1icon.png', '1715409265v2icon.png', '1715409265v3icon.png', 'asad@asad.com', NULL, NULL, NULL, NULL, NULL, 'active', NULL, NULL, NULL, '2024-05-11 00:34:25');
...
(1, 'Admin', 'admin@admin.com', NULL, '$2y$12$nknp29KdKKPzfYDCGLxUC.uTi1sR8szOwYUicZ8KxXYYoSkzO8.oW', NULL, NULL, '2024-05-09 12:08:18');
...
--
-- Indexes for table `aztokens`
--
ALTER TABLE `aztokens`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `aztokens`
--
ALTER TABLE `aztokens`
